...
import { patients, type Trend, type Risk } from "@/data/patients";
      ...
      <div className="space-y-3 pb-4">
        {patients.map((p) =>
          p.nadi ? (
            ...
            <Card key={p.name} onClick={() => navigate(`/patients/${p.id}`)}>
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-muted-foreground mt-1">
                    Last visit: <span className="text-foreground/80">{p.lastVisit}</span>
                  </p>
                </div>
